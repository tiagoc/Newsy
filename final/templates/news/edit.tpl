            ...
            <form>
                ...
                <div class="row">
                    <div class="large-10 columns">
                        ...
                        <textarea name="synopsis" required>{$article.synopsis}</textarea>
                ...
                <div class="row">
                    <div class="large-10 columns">
                        ...
                        <input type="text" name="categories" required value="{foreach $article.categories as $c name=inputcatlist}
                               {$c.name}
                               {if not $smarty.foreach.inputcatlist.last}, {/if}
                               {/foreach}"/>
